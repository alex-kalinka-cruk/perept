#' bpr_true
#'
#' Calculates a Bayesian posterior probability that a given test subject (e.g. a gene) has a given result (either negative or positive).
#'
...
#' @param expected An integer value (either 0 or 1) indicating whether the expected result was negative (0) or positive (1).
