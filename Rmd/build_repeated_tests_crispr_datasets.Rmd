...
# Original screen structure - median z-score gene summary + median logfc.
files.drugz.orig <- list.files(file.path(params$root,"output","drugz","original_screen_structure","cleanr_medzscore_medfc"), 
                    pattern = "txt$", full.names = T)
ht29.drugz_hit_matrix.orig <- process_drugz_output(files.drugz.orig)
...
# Original screen structure - median z-score gene summary + median logfc + no zscore.
files.drugz.orig <- list.files(file.path(params$root,"output","drugz","original_screen_structure","cleanr_medzscore_nozs"), 
                    pattern = "txt$", full.names = T)
ht29.drugz_hit_matrix.orig <- process_drugz_output(files.drugz.orig)
